...
<div class="main-content container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Update User (Student and Admin)</h3>
            </div>
    ...
    <div class="card">
        ...
        <h4 class="card-title">If you update a Student account you must to Fill all of following</h4>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input name="name" value="{{ $user->name }}" type="text" class="form-control" placeholder="Ali Jasim" id="first-name-icon">
                    ...
                    <div class="col-6">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input name="email" value="{{ $user->email }}" type="email" class="form-control" placeholder="Email" id="email-id-icon">
                                <div class="form-control-icon">
                        ...
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <select name="dept" id="" class="form-control">
                                    ...
                                    <option value="computers" {{ $user->dept == 'computers' ? 'selected' : '' }}>Computers</option>
                                    <option value="softwares" {{ $user->dept == 'softwares' ? 'selected' : '' }}>Softwares</option>
                                </select>
                                <div class="form-control-icon">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input step="0.01" name="first_avg" value="{{ $user->first_avg }}" type="number" class="form-control" placeholder="90.5" id="first-name-icon">
                                <div class="form-control-icon">
                    ...
                    <div class="col-6">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input step="0.01" name="second_avg" value="{{ $user->second_avg }}" type="number" class="form-control" placeholder="80.5" id="first-name-icon">
                                <div class="form-control-icon">
                                    <i data-feather="percent"></i>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group has-icon-left">
                            <h5 for="password-id-icon">Password</h5>
                            <div class="position-relative">
                    ...
                    <div class="col-6">
                        <div class="form-group has-icon-left">
                            <h5 for="password-id-icon">Repeat Password</h5>
                            <div class="position-relative">
                                <input type="password" class="form-control "
                        ...
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <select class="form-control" id="role" name="is_admin">
                                    <option value="" disabled selected>Choose one...</option>
                                    <option value="0" {{ $user->isAdmin() ? '' : 'selected' }}>Student</option>
